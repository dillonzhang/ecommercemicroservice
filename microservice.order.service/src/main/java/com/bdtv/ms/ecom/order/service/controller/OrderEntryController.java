...
public class OrderEntryController {
	...
	public ResponseEntity<Set<OrderEntry>> getOrderById(
			@PathVariable Long orderId) {
		Set<OrderEntry> entries = this.orderService
				.getOrderEntriesByOrderId(orderId);
	...
	public ResponseEntity<OrderEntry> createOrderEntry(
			@PathVariable Long orderId,
			@Valid @RequestBody OrderEntry orderEntry) {
	...
	public ResponseEntity<OrderEntry> updateOrder(@PathVariable Long orderId,
			@PathVariable Long orderEntryId,
			@Valid @RequestBody OrderEntry orderEntry) {
		OrderEntry oe = this.orderService.updateOrderEntry(orderId,
				orderEntryId, orderEntry);
		return ResponseEntity.status(HttpStatus.OK).body(oe);
	}
