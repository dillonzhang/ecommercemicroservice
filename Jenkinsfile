    ...
    stage('Deploy to Kubernetes') {
        ...
        microserviceProjects.each { projectName ->
            if(projectName == "microservice.config"){
                sh "/usr/local/bin/kubectl delete -f ${projectName}/config-server-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
            ...
            if(projectName == "microservice.customer.service"){
                sh "/usr/local/bin/kubectl delete -f ${projectName}/mysql-customer-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
                sh "/usr/local/bin/kubectl delete -f ${projectName}/customer-service-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
            ...
            if(projectName == "microservice.discovery.eureka"){
                sh "/usr/local/bin/kubectl delete -f ${projectName}/discovery-eureka-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
            ...
            if(projectName == "microservice.hystrix.dashboard"){
                sh "/usr/local/bin/kubectl delete -f ${projectName}/hystrix-dashboard-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
            ...
            if(projectName == "microservice.hystrix.turbine"){
                sh "/usr/local/bin/kubectl delete -f ${projectName}/hystrix-turbine-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
            ...
            if(projectName == "microservice.order.service"){
                sh "/usr/local/bin/kubectl delete -f ${projectName}/mysql-order-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
                sh "/usr/local/bin/kubectl delete -f ${projectName}/order-service-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
            ...
            if(projectName == "microservice.product.service"){
                sh "/usr/local/bin/kubectl delete -f ${projectName}/mysql-product-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
                sh "/usr/local/bin/kubectl delete -f ${projectName}/product-service-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
            ...
            if(projectName == "microservice.zipkin.service"){
                sh "/usr/local/bin/kubectl delete -f ${projectName}/zipkin-service-deployment.yaml  --kubeconfig=/var/lib/jenkins/kubeconfig"
